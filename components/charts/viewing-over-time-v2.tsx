...
export function ViewingOverTimeV2({ data }: ViewingOverTimeV2Props) {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      {/* Stats */}
      <div className="grid grid-cols-2 gap-3 p-3 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10">
        <div>
          <p className="text-xs text-slate-600 dark:text-slate-400">Peak Period</p>
