...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-900 pb-20 md:pb-32">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="text-slate-400 dark:text-white/30 text-sm"
          >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-slate-950 via-transparent dark:to-slate-950/80 pointer-events-none" />
    </div>
  );
};
