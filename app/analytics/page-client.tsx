  ...
  return (
    <SidebarProvider defaultOpen={defaultSidebarOpen} suppressHydrationWarning>
      ...
      <SidebarInset suppressHydrationWarning>
        <div className="flex flex-col h-screen bg-white dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 scroll-smooth" suppressHydrationWarning>
          <AnalyticsHeader
